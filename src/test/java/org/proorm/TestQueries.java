...
import org.proorm.utils.RSUtils;
...
//        config.dataSource("jdbc:h2:mem:test-single;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;", "", "")
...
//        IDatabaseConfig config;
//        config = new DatabaseConfig();
//        config.dataSource("jdbc:h2:mem:test-batch;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;", "", "")
...
//    // IDatabaseConfig config;
//    // config = new DatabaseConfig();
//    config// .dataSource("jdbc:postgresql://localhost/jminiorm", "jminiorm", "jminiorm")
//    // .statementExecutor(new DefaultStatementExecutor())
